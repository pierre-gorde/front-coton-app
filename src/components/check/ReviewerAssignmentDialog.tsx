 ...
 * Dialog for assigning/unassigning reviewers (freelances) to a mission
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[525px]">
        <DialogHeader>
          <DialogTitle>Assigner des reviewers</DialogTitle>
          <DialogDescription>
            Sélectionnez les freelances qui vont évaluer les candidats de ce poste.
